/*!
 *
 * A interpolation module that works for functions of order up to cubic. Created to be fast.
 *
 * @name	Interpolation
 ...
 *	Interpolation.quadratic(2,4,3,6,4,8, 6); // Original, fastest
 *	Interpolation.degree2(2,4,3,6,4,8, 6); // Original, just as fast as the other
 *	Interpolation.any(2,4,3,6,4,8, 6); // Uses argument length to figure which size automatically, 
 *	Interpolation.any(2,4,3,6,4,8).at(6); // Figures you sent 6 pairs of (x,y) and gives you an object with .at to evaluate.
 */
